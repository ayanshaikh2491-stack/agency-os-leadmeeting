...
# -- GPU Detection (handles ALL Kaggle GPU types: T4, P100, G100, L4, A100) --
import subprocess, sys, json, os, traceback

GPU_NAME = "unknown"
GPU_MODE = "check_cap"  # check_cap | supported | unsupported | cpu_fallback
try:
    ...
    # Known good GPUs
    elif any(x in out for x in ["g100", "a100", "l4", "t4", "rtx"]):
        GPU_MODE = "supported"
        print(f"GPU detected: {GPU_NAME} -- will use CUDA")
    else:
        GPU_MODE = "check_cap"
        print(f"GPU detected: {GPU_NAME} -- checking compute capability")
