...
# --- FIX: P100 (sm_60) needs torch w/ CUDA 11.8 ---
...
def _fix_torch():
    try:
        ...
        if "p100" in out or "sm_6.0" in out or "sm_60" in out:
            print("P100 detected. Reinstalling torch with CUDA 11.8...")
            ...
            for mod in list(sys.modules.keys()):
                if "torch" in mod:
                    del sys.modules[mod]
            print("torch reinstalled with CUDA 11.8")
...
if torch.cuda.is_available():
    try:
        ...
        if cap[0] >= 7:
            ...
            print("GPU too old, falling back to CPU")
    except Exception as e:
