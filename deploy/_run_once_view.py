...
def ssh(cmd, timeout=30):
    ...
    print(r.stdout.strip()[:4500])
    if r.stderr.strip():
        print("ERR:", r.stderr.strip()[:400])
    return r

print("=== run_once lead pool logic (lines 748-810) ===")
ssh("sed -n '748,815p' /home/ubuntu/sba-backend/admin/agency/sba_autopilot.py", timeout=30)
