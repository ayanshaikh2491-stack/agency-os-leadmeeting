...
ssh("systemctl is-active sba-gateway.service; curl -s -m 10 http://127.0.0.1:8095/health; echo", timeout=30)
ssh("sudo journalctl -u sba-gateway.service --no-pager -n 15 | tail -15", timeout=30)
